...
var paginateMaxID = "";
        ...
        var paginateCountPerPage = 100;

export default class ArchivedPOTable extends Component {
    ...
    itemViewFormatter =(props) => {
        return <Link className="table-anchor" to={`/po-request/ArchivedPOview/${props.dependentValues.ID}`}>POTN{props.value}</Link>    
    };
                ...
                <Card style={tableContainer}>
                    <Row>
                        <Col style={headerStyle} className="form-header-container" md={12}>
                            ...
                            <h5 className="form-header">Archived Purchase Order Requests</h5>
                        </Col>
